...
<body>
    ...
    <body>
        ...
        <div class="faq-card" onclick="this.classList.toggle('active')">
            ...
            <div class="faq-answer">After logging in, navigate to your account settings or profile page, select the option to change your password, then enter your current password followed by the new password twice to confirm.</div>
        </div>
        ...
        <div class="faq-card" onclick="this.classList.toggle('active')">
            ...
            <div class="faq-answer">Users usually need to provide their full name, email address, contact number, address, organization/company name, account type (incubatees and investors), valid identification document (ID) and create a password.</div>
        </div>
