    ...
    <div class="filter-container">
        <div style="display: flex; gap: 30px; flex-wrap: wrap; align-items: flex-end;">
            ...
            <div style="display: flex; gap: 10px; align-items: flex-end;">
                ...
                style="height: 36px; padding: 0 12px; border: 1px solid #d1d5db; border-radius: 6px; display: flex; align-items: center; gap: 5px; color: #27272a; font-size: 12px; font-weight: 600; text-decoration: none; transition: 0.2s;"
            ...
            <table  class="table-card" style="width: 100%; border-collapse: collapse; font-size: 12px;">
                <thead>
                    <tr style="background-color: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                        <th style="padding: 12px 15px; text-align: left; color: #27272a;">Supply Name</th>
        ...
        @if($outOfStock->count() > 0)
            <div style="border-radius: 10px; overflow: hidden; margin-bottom: 25px;">
                ...
                <table class="table-card" style="width: 100%; border-collapse: collapse; font-size: 11px;">
                    <thead>
                        <tr style="background-color: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                            <th style="padding: 10px 15px; text-align: left; color: #27272a;">Supply</th>
