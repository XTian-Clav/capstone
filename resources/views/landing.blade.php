  ...
  <body>
    ...
    <header class="header__container">
      ...
      <div class="header__content">
        <h1><span class="secondary">PALAWAN INTERNATIONAL</span> <span>TECHONOLOGY BUSINESS INCUBATOR</span> <span class="secondary">| PORTAL</span></h1>
        <p>
          Nurturing the Future of Startups in MIMAROPA by providing critical resources,
          mentorship, and ecosystem needed to transform research and innovative startup
          ideas into sustainable and commercially viable businesses.
        </p>
