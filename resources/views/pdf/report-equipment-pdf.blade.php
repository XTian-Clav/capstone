<head>
    <title>Equipment Report - {{ now()->format('M-d-Y') }}</title>
...
<div style="margin: 0.4in; background: white; font-family: font-family: 'Times New Roman', Times, serif;">
    ...
    <table style="width: 100%; margin-bottom: 50px; text-align: center;">
        <tr>
            ...
            <td style="width: 60%; text-align: center; vertical-align: top;">
                ...
                <div style="font-size: 14px; font-weight: 700; margin-bottom: 2px;">Equipment Report</div>
    ...
    @include('pdf-template.pdf-template-report-equipment')
</div>