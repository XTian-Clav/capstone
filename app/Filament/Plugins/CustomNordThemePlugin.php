...
class CustomNordThemePlugin implements Plugin
{
    ...
    public function register(Panel $panel): void
    {
        $panel
            ->colors([
                ...
                'primary' => Color::hex('#013267'), // pitbi color orange
                'secondary' => Color::hex('#fe800d'), // pitbi color blue
