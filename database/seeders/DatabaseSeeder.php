...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedOtherData(): void
    {
        ...
        $equipments = [
            ...
            ['equipment_name' => 'AVR Secure', 'location' => 'PITBI Office'],
            ['equipment_name' => 'Printer, HP LaserJet Pro MFP M130nw', 'location' => 'PITBI Office'],
            ['equipment_name' => 'Whiteboard', 'location' => 'PITBI Office'],
        ...
        $supplies = [
            ...
            ['item_name' => 'Vellum Board 8.5 x 11', 'location' => 'PITBI Office'],
            ['item_name' => 'Short Oslo Paper', 'location' => 'PITBI Office'],
            ['item_name' => 'Sandisk Extreme Pro - 128 GB', 'location' => 'PITBI Office'],
            ['item_name' => 'Security White Envelope', 'location' => 'PITBI Office'],
            ['item_name' => 'Pixma Ink Magenta', 'location' => 'PITBI Office'],
            ['item_name' => 'Pixma Ink Cyan', 'location' => 'PITBI Office'],
            ['item_name' => 'Pixma Ink Yellow', 'location' => 'PITBI Office'],
            ['item_name' => 'Pilot Super Color Marker (BLUE)', 'location' => 'PITBI Office'],
            ['item_name' => 'Pilot Super Color Marker (BLACK)', 'location' => 'PITBI Office'],
            ['item_name' => 'PIlot Super Color Marker (RED)', 'location' => 'PITBI Office'],
            ['item_name' => 'Photo Paper A4', 'location' => 'PITBI Office'],
            ['item_name' => 'Scissors', 'location' => 'PITBI Office'],
            ['item_name' => 'Tape', 'location' => 'PITBI Office'],
            ['item_name' => 'Manila paper', 'location' => 'PITBI Office'],
            ['item_name' => 'Nylon Cable Tie', 'location' => 'PITBI Office'],
            ['item_name' => 'Epson Ink 003 Black', 'location' => 'PITBI Office'],
            ['item_name' => 'Epson Ink 003 Magenta', 'location' => 'PITBI Office'],
            ['item_name' => 'All Purpose Glue', 'location' => 'PITBI Office'],
            ['item_name' => 'Epson Ink 003 Cyan ', 'location' => 'PITBI Office'],
        ];
